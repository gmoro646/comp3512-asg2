        ...
        <div class="container">
            <div class="pull-right">
                <ul class="list-inline">
                    <?php   //changeLoginLogout(); ?>
                    <li><a href="logout.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                    <li><a href="login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                    <li><a href="user-home.php"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
    ...
    <nav class="navbar navbar-default ">
        <div class="container">
            <div class="navbar-header">
                ...
                <img src="/asg3/images/misc/logo_large.PNG" height="60" width="60" href="index.php"></img>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form action="browse-images.php?title=" class="navbar-form navbar-right" role="search" method="get">
