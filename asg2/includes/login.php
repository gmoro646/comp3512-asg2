...
.modal {
    ...
    background-color: rgb(9,9,9); /* Fallback color */
...
<div id="loginid" class="modal">
  ...
  <form class="modal-content animate" method="post">
    <div class="imgcontainer">
      ...
      <img class=avatar src="images/misc/baby.gif" alt="Logo" width="60" height="250">
    </div>
    ...
    <div class="container">
      ...
      <label for="psw" style="color:black;"><b>Password</b></label></div>
      <input type="password" placeholder="Enter Password" name="psw" required>
    Remember Me: <input type="checkbox" name="rememberme" value="1"><br>
      <button action:"/login2.php" type="submit" style="width:100%;">Login</button>
